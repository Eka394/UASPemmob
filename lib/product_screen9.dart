...
class ProductScreen9 extends StatelessWidget {
  List<String> images = [
    "assets/image4.jpg",
    "assets/image4.1.jpg",
    "assets/image4.2.jpg",
  ...
  double totalPrice = 90000; // Harga awal
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        "Child Win adalah pakaian atau perlengkapan anak-anak yang dirancang untuk memberikan kenyamanan dan gaya saat beraktivitas sehari-hari.",
                        style: TextStyle(
                          color: Colors.black54,
                          fontWeight: FontWeight.w500,
                          fontSize: 16,
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      if (quantity > 1) {
                                        quantity--;
                                        totalPrice -= 90000; // Decrease total price
                                      }
                                    });
                                  },
                                  child: Container(
                                ...
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      quantity++;
                                      totalPrice += 90000; // Increase total price
                                    });
                                  },
                                  child: Container(
                                    width: 40,
                    ...
                    InkWell(
                      onTap: () {
                        SelectedProduct selectedProduct = SelectedProduct(
                          productImage: "assets/image4.jpg",
                          productName: "Child Win",
