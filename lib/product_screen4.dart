...
class ProductScreen4 extends StatelessWidget {
  List<String> images = [
    "assets/image11.jpg",
    "assets/image11.1.jpg",
    "assets/image11.2.jpg",
    "assets/image11.4.jpg"
  ];
  ...
  double totalPrice = 102000; // Harga awal
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        "Blus Bunga adalah atasan yang dirancang dengan motif bunga yang cerah dan menawan, menambah sentuhan feminin dan segar pada penampilan anda.",
                        style: TextStyle(
                          color: Colors.black54,
                          fontWeight: FontWeight.w500,
                          fontSize: 16,
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      if (quantity > 1) {
                                        quantity--;
                                        totalPrice -= 102000; // Decrease total price
                                      }
                                    });
                                  },
                                  child: Container(
                                ...
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      quantity++;
                                      totalPrice += 102000; // Increase total price
                                    });
                                  },
                                  child: Container(
                                    width: 40,
                    ...
                    InkWell(
                      onTap: () {
                        SelectedProduct selectedProduct = SelectedProduct(
                          productImage: "assets/image11.jpg",
                          productName: "Blus Bunga",
