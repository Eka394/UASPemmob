...
class ProductScreen2 extends StatelessWidget {
  ...
  double totalPrice = 97000; // Harga awal
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        "Sweater Rajut adalah pakaian atasan yang dirajut dari benang berkualitas tinggi, memberikan kehangatan dan kenyamanan yang ideal untuk cuaca dingin.",
                        style: TextStyle(
                          color: Colors.black54,
                          fontWeight: FontWeight.w500,
                          fontSize: 16,
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      if (quantity > 1) {
                                        quantity--;
                                        totalPrice -= 97000; // Decrease total price
                                      }
                                    });
                                  },
                                  child: Container(
                                ...
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      quantity++;
                                      totalPrice += 97000; // Increase total price
                                    });
                                  },
                                  child: Container(
                                    width: 40,
                    ...
                    InkWell(
                      onTap: () {
                        SelectedProduct selectedProduct = SelectedProduct(
                          productImage: "assets/image9.jpg",
