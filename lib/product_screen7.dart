...
class ProductScreen7 extends StatelessWidget {
  List<String> images = [
    "assets/image2.jpg",
    "assets/image2.1.jpg",
    "assets/image2.2.jpg",
  ...
  double totalPrice = 83000; // Harga awal
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        "Knit Wool adalah pakaian rajutan yang terbuat dari wol berkualitas tinggi. Knit Wool cocok dipakai untuk gaya santai atau semi-formal.",
                        style: TextStyle(
                          color: Colors.black54,
                          fontWeight: FontWeight.w500,
                          fontSize: 16,
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      if (quantity > 1) {
                                        quantity--;
                                        totalPrice -= 83000; // Decrease total price
                                      }
                                    });
                                  },
                                  child: Container(
                                ...
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      quantity++;
                                      totalPrice += 83000; // Increase total price
                                    });
                                  },
                                  child: Container(
                                    width: 40,
                    ...
                    InkWell(
                      onTap: () {
                        SelectedProduct selectedProduct = SelectedProduct(
                          productImage: "assets/image2.jpg",
                          productName: "Knit Wool",
