...
class ProductScreen extends StatelessWidget {
  ...
  double totalPrice = 74000; // Harga awal
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        "Rok A-Line adalah pakaian bawahan yang dirancang dengan potongan yang melebar dari pinggang hingga ke bawah.",
                        style: TextStyle(
                          color: Colors.black54,
                          fontWeight: FontWeight.w500,
                          fontSize: 16,
                                                  ...
                                                  children: [
                                                    GestureDetector(
                                                      onTap: () {
                                                        setState(() {
                                                          if (quantity > 1) {
                                                            quantity--;
                                                            totalPrice -= 74000; // Decrease total price
                                                          }
                                                        });
                                                      },
                                                      child: Container(
                                                    ...
                                                    GestureDetector(
                                                      onTap: () {
                                                        setState(() {
                                                          quantity++;
                                                          totalPrice += 74000; // Increase total price
                                                        });
                                                      },
                                                      child: Container(
                                                        width: 40,
                                        ...
                                        InkWell(
                                          onTap: () {
                                            SelectedProduct selectedProduct = SelectedProduct(
                                              productImage: "assets/image7.jpg",
                                              productName: "Rok A-Line",
