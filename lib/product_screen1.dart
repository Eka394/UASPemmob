...
class ProductScreen1 extends StatelessWidget {
  ...
  double totalPrice = 88000; // Harga awal
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        "Blus Sifon Seri adalah atasan yang elegan dan ringan, terbuat dari bahan sifon berkualitas tinggi yang memberikan kesan anggun dan feminin.",
                        style: TextStyle(
                          color: Colors.black54,
                          fontWeight: FontWeight.w500,
                          fontSize: 16,
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      if (quantity > 1) {
                                        quantity--;
                                        totalPrice -= 88000; // Decrease total price
                                      }
                                    });
                                  },
                                  child: Container(
                                ...
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      quantity++;
                                      totalPrice += 88000; // Increase total price
                                    });
                                  },
                                  child: Container(
                                    width: 40,
                    ...
                    InkWell(
                      onTap: () {
                        SelectedProduct selectedProduct = SelectedProduct(
                          productImage: "assets/image8.jpg",
                          productName: "Blus Sifon Seri",
