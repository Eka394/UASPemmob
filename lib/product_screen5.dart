...
class ProductScreen5 extends StatelessWidget {
  List<String> images = [
    "assets/image12.jpg",
    "assets/image12.1.jpg",
    "assets/image12.2.jpg",
    "assets/image12.3.jpg"
  ];
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        "Kaus V-Neck adalah atasan yang didesain dengan leher berbentuk 'V', memberikan tampilan yang modern dan stylish. Terbuat dari bahan katun yang lembut dan nyaman",
                        style: TextStyle(
                          color: Colors.black54,
                          fontWeight: FontWeight.w500,
                          fontSize: 16,
                    ...
                    InkWell(
                      onTap: () {
                        SelectedProduct selectedProduct = SelectedProduct(
                          productImage: "assets/image12.jpg",
                          productName: "Kaus V-Neck",
