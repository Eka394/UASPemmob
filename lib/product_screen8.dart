...
class ProductScreen8 extends StatelessWidget {
  List<String> images = [
    "assets/image3.jpg",
    "assets/image3.1.jpg",
    "assets/image3.2.jpg",
  ...
  double totalPrice = 100000; // Harga awal
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        "Zipper Win adalah jaket atau pakaian luar dengan desain yang dilengkapi dengan resleting, memberikan kemudahan saat mengenakan atau melepasnya.",
                        style: TextStyle(
                          color: Colors.black54,
                          fontWeight: FontWeight.w500,
                          fontSize: 16,
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      if (quantity > 1) {
                                        quantity--;
                                        totalPrice -= 100000; // Decrease total price
                                      }
                                    });
                                  },
                                  child: Container(
                                ...
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      quantity++;
                                      totalPrice += 100000; // Increase total price
                                    });
                                  },
                                  child: Container(
                                    width: 40,
                    ...
                    InkWell(
                      onTap: () {
                        SelectedProduct selectedProduct = SelectedProduct(
                          productImage: "assets/image3.jpg",
                          productName: "Zipper Win",
