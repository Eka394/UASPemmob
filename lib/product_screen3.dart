...
class ProductScreen3 extends StatelessWidget {
  List<String> images = [
    "assets/image10.jpg",
    "assets/image10.1.jpg",
    "assets/image10.2.jpg",
    "assets/image10.3.jpg"
  ];
  ...
  double totalPrice = 95000; // Harga awal
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        "Celana Chino adalah pilihan pakaian bawahan yang menawarkan kombinasi sempurna antara kenyamanan dan gaya serta memberikan tampilan yang rapi dan serbaguna.",
                        style: TextStyle(
                          color: Colors.black54,
                          fontWeight: FontWeight.w500,
                          fontSize: 16,
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      if (quantity > 1) {
                                        quantity--;
                                        totalPrice -= 95000; // Decrease total price
                                      }
                                    });
                                  },
                                  child: Container(
                                ...
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      quantity++;
                                      totalPrice += 95000; // Increase total price
                                    });
                                  },
                                  child: Container(
                                    width: 40,
                    ...
                    InkWell(
                      onTap: () {
                        SelectedProduct selectedProduct = SelectedProduct(
                          productImage: "assets/image10.jpg",
